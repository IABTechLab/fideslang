...
DEFAULT_TAXONOMY = Taxonomy(
    data_category=[
        ...
        DataCategory(
            fides_key="user.account.country",
            organization_fides_key="default_organization",
        ...
        DataCategory(
            fides_key="user.account.phone_number",
            organization_fides_key="default_organization",
        ...
        DataCategory(
            fides_key="user.account.postal_code",
            organization_fides_key="default_organization",
        ...
        DataCategory(
            fides_key="user.account.payment",
            organization_fides_key="default_organization",
            name="Payment Data",
        ...
        DataCategory(
            fides_key="user.account.payment.financial_account_number",
            organization_fides_key="default_organization",
            ...
            parent_key="user.account.payment",
        ),
        DataCategory(
            fides_key="system",
            organization_fides_key="default_organization",
        ...
        DataCategory(
            fides_key="user.unique_id",  # TODO should this be tied to account as well potentially?
            organization_fides_key="default_organization",
            name="Unique ID",
        ...
        DataCategory(
            fides_key="user.sensor",  # TODO is this different than user_sensor
            organization_fides_key="default_organization",
            name="Sensor Data",
        ...
        DataCategory(
            fides_key="user.contact.city",
            organization_fides_key="default_organization",
            name="User Provided City",  # TODO the names of these full like they could be refreshed as well
            description="User's city level address data.",
            parent_key="user.contact",
        ),
        DataCategory(
            fides_key="user.contact.country",
            organization_fides_key="default_organization",
        ...
        DataCategory(
            fides_key="user.contact.postal_code",
            organization_fides_key="default_organization",
        ...
        DataCategory(
            fides_key="user.credentials.password",  # TODO move this (and others) to account?
            organization_fides_key="default_organization",
            name="Password",
