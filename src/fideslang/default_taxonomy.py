...
DEFAULT_TAXONOMY = Taxonomy(
    data_category=[
        ...
        DataCategory(
            fides_key="user.account.address",
            organization_fides_key="default_organization",
            name="Account Data",
            description="Data related to a system account address",
            parent_key="user.account",
        ),
        DataCategory(
            fides_key="user.account.address.city",
            organization_fides_key="default_organization",
            name="Account City",
            description="Account's city level address data.",
            parent_key="user.account.address",
        ),
        DataCategory(
            fides_key="user.account.address.country",
            organization_fides_key="default_organization",
        ...
        DataCategory(
            fides_key="user.account.address.postal_code",
            organization_fides_key="default_organization",
        ...
        DataCategory(
            fides_key="user.account.address.state",
            organization_fides_key="default_organization",
            name="Account State",
        ...
        DataCategory(
            fides_key="user.account.address.street",
            organization_fides_key="default_organization",
            name="Account Street",
