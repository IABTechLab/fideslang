...
DEFAULT_DATA_USES = [
    ...
    DataUse(
        ...
        name="Analytics",
        description="Provices analytics for activities such as system and advertising performance reporting, insights and fraud detection.",
        parent_key=None,
        is_default=True,
    ),
    DataUse(
    ...
    DataUse(
        ...
        description="Servies advertisements based on first party data collected or derived about the user.",
    ...
    DataUse(
        ...
        description="Sends e-mail marketing communications.",
    ...
    DataUse(
        ...
        name="Operations",
        organization_fides_key="default_organization",
        description="Supporets business processes necessary to the organization's operation.",
        parent_key=None,
        is_default=True,
    ),
    # Personalize
